      ...
      <div>
        <div className="flex gap-3 p-2 cursor-pointer font-semibold rounded ">
          <div className="md:w-16 md:h-16 w-10 h-10">
            <span>
              <span></span>
              <img alt="itcube" src={logo} className="rounded-full" /></span></div>
          <div>
            <div className="flex items-center gap-2">
              <p className="flex gap-2 items-center md:text-md font-bold text-primary">{post.caption}</p>
              <GoVerified className='text-blue-400 text-md' />
                <p className="capitalize font-medium text-xs text-gray-500 hidden md:block">{post.topic}</p></div>
